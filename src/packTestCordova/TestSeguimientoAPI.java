...
public class TestSeguimientoAPI {
	...
	public void test() {
		...
		try {
			peticion = new PeticionPost("http://127.0.0.1:8080/TFG/api/SeguimientoAPI");
			JSONObject json = null;
			try {
				peticion.add("idO", String.valueOf(idObra));
				peticion.add("idU", String.valueOf(idUs));
				peticion.add("valor", String.valueOf(1));
