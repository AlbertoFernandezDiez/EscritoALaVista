...
public class TestEliminarCapituloAPI {
	...
	public void testDoPostHttpServletRequestHttpServletResponse() {
		...
		try {
			peticion = new PeticionPost("http://127.0.0.1:8080/TFG/api/EliminarCapituloAPI");
			JSONObject json = null;
			try {
				peticion.add("loggedid", String.valueOf(idUs));
				peticion.add("capitulo", String.valueOf(idCap));
