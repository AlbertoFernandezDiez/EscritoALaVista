...
public class TestGestionarUsuarios {
	...
	public void setUp() throws Exception {
		driver.get("http://localhost:8080/TFG/EU");
	}
	...
	public void testPulsarBoton() {
		long time;
		WebElement row = driver.findElement(By.id(String.valueOf(idU)));
		...
		row = driver.findElement(By.id(String.valueOf(idU)));
