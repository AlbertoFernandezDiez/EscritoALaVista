...
public class TestMostrarCapitulo {
	...
	public void testDoPostHttpServletRequestHttpServletResponse() {
		...
		try {
			peticion = new PeticionPost("http://127.0.0.1:8080/TFG/api/MostrarCapitulo");
			JSONObject json = null;
			try {
				peticion.add("id", String.valueOf(idCap));


				json = new JSONObject(peticion.getRespueta());
				assertEquals(String.valueOf(aux), json.get("titulo"));
				assertEquals(String.valueOf(aux), json.get("comentarioAutor"));
