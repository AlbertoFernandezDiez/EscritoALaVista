...
public class TestCambiarContrasenaAPI {
	...
	public void testDoPostHttpServletRequestHttpServletResponse() {
		...
		try {
			peticion = new PeticionPost("http://127.0.0.1:8080/TFG/api/CambioContraAPI");
			JSONObject json = null;
			try {
				peticion.add("loggedID", String.valueOf(idUs));
				peticion.add("conV", String.valueOf(aux));
				peticion.add("conN", String.valueOf(0));
