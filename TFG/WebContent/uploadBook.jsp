...
<body>
	...
	<form action="uploadBook.jsp" method="POST">
		<select id="selectObra" name="selectObra" size=1
			onChange="loadChapters($('#selectObra').val(),$('#selectCapitulo').val())">
			...
			:</label>
		<textarea rows="5" cols="20" id="resumen" name="resumen"></textarea>
		<br> <label for="titCap">Titulo Capitulo :</label> <input
			type="text" id="titCap" name="titCap"> <br> <label
			for="capitulo">Capitulo :</label>
		<textarea rows="5" cols="20" id="capitulo" name="capitulo"></textarea>
		<br> <label for="comentarios">Comentarios :</label>
		<textarea rows="5" cols="20" id="comentarios" name="comentarios"></textarea>
